...
#Region " Class TabPageCollection "
    ...
    Public Class TabPageCollection
        ...
        Public Function Add(ByVal Form As Form) As TabPage
            ...
            AddHandler TabPage.Dragging, AddressOf TabPage_Dragging
            AddHandler TabPage.EndDrag, AddressOf TabPage_EndDrag
        ...
        Public Function TearOff(ByVal TabPage As TabPage) As Form
            Dim f As Form = TabPage.m_Form
        ...
        Private CurrentTab As TabPage = Nothing

        Private Sub TabPage_Dragging(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs)
            If TabControl.AllowTabReorder AndAlso e.Button = Windows.Forms.MouseButtons.Left Then
                ...
                If t Is Nothing Then
                    CurrentTab = Nothing
                ElseIf t IsNot CurrentTab Then
                    ' swap the tabpages
        ...
        Private Sub TabPage_EndDrag(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs)
            CurrentTab = Nothing
        End Sub
...
#End Region
    ...
    'This sets the value of the button variable for the plus button
    ...
    'The new tab button (and other things) is(are) in here
...
#Region "Drag"
    ...
    '(c)Copyright Josiah Horton 2014-2016

    Dim posX As Integer
    Dim posY As Integer
    Dim drag As Boolean

    Private Sub pnlTabs_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles pnlTabs.MouseDown
        If e.Button = MouseButtons.Left Then
            drag = True
            'posX = Cursor.Position.X - Me.Left
            'posY = Cursor.Position.Y - Me.Top
            posX = Cursor.Position.X - ParentForm.Left
            posY = Cursor.Position.Y - ParentForm.Top
        End If
    End Sub

    Private Sub pnlTabs_MouseUp(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles pnlTabs.MouseUp
        drag = False
    End Sub

    Private Sub pnlTabs_MouseMove(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles pnlTabs.MouseMove
        If drag Then
            'Me.Top = Cursor.Position.Y - posY
            'Me.Left = Cursor.Position.X - posX
            ParentForm.Top = Cursor.Position.Y - posY
            ParentForm.Left = Cursor.Position.X - posX
        End If
